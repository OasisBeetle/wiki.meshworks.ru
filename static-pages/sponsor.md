...
<div className="sponsorGrid">
  ...
  <div className="sponsorInfoCard">
    <h3>Контент</h3>
    <p>Новые гайды и обновления статей.</p>
  </div>
  <div className="sponsorInfoCard">
    <h3>Инструменты</h3>
    <p>Прошивальщик, карта и полезные утилиты.</p>
  </div>
</div>
...
:::tip
Если хотите помочь правками, начните с раздела: [/wiki/how-to-edit](/wiki/how-to-edit).
:::
